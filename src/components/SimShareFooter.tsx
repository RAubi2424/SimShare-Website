...
function SocialIcons() {
  ...
  const iconColor = isDark ? '#D0D0D0' : '#333333';
  ...
  return (
    ...
    >
      ...
      <a
        ...
        aria-label="LinkedIn"
      >
        <svg style={iconStyle} fill={iconColor} viewBox="0 0 24 24">
      ...
      {/* Instagram */}
      <a
        href="https://www.instagram.com/simsharegolf/"
        target="_blank"
        rel="noopener noreferrer"
        style={{ display: 'flex', alignItems: 'center' }}
        onMouseEnter={e => {
...
export function SimShareFooter() {
  const { theme } = useTheme();
  const isDark = theme === 'dark';
